...
| `CURUNIR_*.md`, `CURUNIR_*.json`, `CURUNIR_V6_7_REFERENCE_COMMITS.txt` | yes | contracts, ledgers, evidence, handoffs — indexed in `CURUNIR_DOCUMENTS.md` |
...
- `argus_neural`, `argus_capsules`, `artifacts/` — `../capsules`.
- `schema.sql`, `docker-compose.yml`, `review_app`, `demo_corpus`, `exports`,
  inboxes, content store — `../kernel`.
